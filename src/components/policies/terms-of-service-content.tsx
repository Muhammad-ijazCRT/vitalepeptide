...
export function TermsOfServiceContent() {
  return (
    <>
      <h2>Overview</h2>
      <p>
        Welcome to Vitale Peptide! The terms &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer to Vitale Peptide. Vitale Peptide operates this store and website, including all related information, content, features, tools, products and services in order to provide you, the customer, with a curated shopping experience (the &quot;Services&quot;). Vitale Peptide is powered by Shopify, which enables us to provide the Services to you. The below terms and conditions, together with any policies referenced herein (these &quot;Terms of Service&quot; or &quot;Terms&quot;) describe your rights and responsibilities when you use the Services. Please read these Terms of Service carefully, as they include important information about your legal rights and cover areas such as warranty disclaimers and limitations of liability. By visiting, interacting with or using our Services, you agree to be bound by these Terms of Service and our{" "}
        <Link href="/policies/privacy-policy">Privacy Policy</Link>. If you do not agree to these Terms of Service or Privacy Policy, you should not use or access our Services.
      </p>
      ...
      <p>
        When you place an order, you are making an offer to purchase. Vitale Peptide reserves the right to accept or decline your order for any reason at its discretion. Your order is not accepted until Vitale Peptide confirms acceptance. We must receive and process your payment before your order is accepted. Please review your order carefully before submitting, as Vitale Peptide may be unable to accommodate cancellation requests after an order is accepted. In the event that we do not accept, make a change to, or cancel an order, we will attempt to notify you by contacting the e‑mail, billing address, and/or phone number provided at the time the order was made. Your purchases are subject to return or exchange solely in accordance with our{" "}
        <Link href="/policies/refund-policy">Refund Policy</Link>. You represent and warrant that your purchases are for your own personal or household use and not for commercial resale or export.
      </p>
      ...
      <p>
        Our Services, including but not limited to all trademarks, brands, text, displays, images, graphics, product reviews, video, and audio, and the design, selection, and arrangement thereof, are owned by Vitale Peptide, its affiliates or licensors and are protected by U.S. and foreign patent, copyright and other intellectual property laws. These Terms permit you to use the Services for your personal, non-commercial use only. You must not reproduce, distribute, modify, create derivative works of, publicly display, publicly perform, republish, download, store, or transmit any of the material on the Services without our prior written consent. Except as expressly provided herein, nothing in these Terms grants or shall be construed as granting a license or other rights to you under any patent, trademark, copyright, or other intellectual property of Vitale Peptide, Shopify or any third party. Unauthorized use of the Services may be a violation of federal and state intellectual property laws. All rights not expressly granted herein are reserved by Vitale Peptide. Vitale Peptide&apos;s names, logos, product and service names, designs, and slogans are trademarks of Vitale Peptide or its affiliates or licensors. You must not use such trademarks without the prior written permission of Vitale Peptide. Shopify&apos;s name, logo, product and service names, designs and slogans are trademarks of Shopify. All other names, logos, product and service names, designs, and slogans on the Services are the trademarks of their respective owners.
      </p>
      ...
      <p>
        Vitale Peptide is powered by Shopify, which enables us to provide the Services to you. However, any sales and purchases you make in our Store are made directly with Vitale Peptide. By using the Services, you acknowledge and agree that Shopify is not responsible for any aspect of any sales between you and Vitale Peptide, including any injury, damage, or loss resulting from purchased products and services. You hereby expressly release Shopify and its affiliates from all claims, damages, and liabilities arising from or related to your purchases and transactions with Vitale Peptide.
      </p>

      <h2>Section 10 — Privacy policy</h2>
      <p>
        All personal information we collect through the Services is subject to our{" "}
        <Link href="/policies/privacy-policy">Privacy Policy</Link>, and certain personal information may be subject to Shopify&apos;s Privacy Policy, which can be viewed{" "}
        <a href="https://www.shopify.com/legal/privacy/app-users" rel="noopener noreferrer" target="_blank">
          here
        </a>
        ...
        <Link href="/policies/privacy-policy">privacy policy</Link> for more details on how we, Shopify, and our partners use your personal information.
      </p>
      ...
      <p>
        <strong>
          EXCEPT AS EXPRESSLY STATED BY VITALE PEPTIDE, THE SERVICES AND ALL PRODUCTS OFFERED THROUGH THE SERVICES ARE PROVIDED &apos;AS IS&apos; AND &apos;AS AVAILABLE&apos; FOR YOUR USE, WITHOUT ANY REPRESENTATION, WARRANTIES OR CONDITIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING ALL IMPLIED WARRANTIES OR CONDITIONS OF MERCHANTABILITY, MERCHANTABLE QUALITY, FITNESS FOR A PARTICULAR PURPOSE, DURABILITY, TITLE, AND NON-INFRINGEMENT. WE DO NOT GUARANTEE, REPRESENT OR WARRANT THAT YOUR USE OF THE SERVICES WILL BE UNINTERRUPTED, TIMELY, SECURE OR ERROR-FREE. SOME JURISDICTIONS LIMIT OR DO NOT ALLOW THE DISCLAIMER OF IMPLIED OR OTHER WARRANTIES SO THE ABOVE DISCLAIMER MAY NOT APPLY TO YOU.
        </strong>
      </p>
      ...
      <p>
        These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws applicable in the jurisdiction where Vitale Peptide is headquartered. You and Vitale Peptide consent to venue and personal jurisdiction in the federal and state courts serving that jurisdiction, where permitted by law.
      </p>
      ...
      <p>
        ...
        <a href="mailto:connectmkamran@yahoo.com">connectmkamran@yahoo.com</a> or{" "}
        <a href="mailto:info@vitalepeptide.com">info@vitalepeptide.com</a>.
      </p>
      <p>
        <strong>Trade name:</strong> Vitale Peptide
        <br />
        <strong>Mailing address:</strong> 656 Central Park Avenue, Suite 108, Scarsdale, NY 10583, United States
      </p>
      <p className="mb-0">
        Additional contact details are listed on our{" "}
        <Link href="/policies/contact-information">Contact information</Link> page.
      </p>
    </>
  );
}
