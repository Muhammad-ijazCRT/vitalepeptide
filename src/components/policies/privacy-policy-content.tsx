  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <strong>Marketing and Advertising.</strong> We use your personal information for marketing and promotional purposes, such as to send marketing, advertising and promotional communications by email, text message or postal mail, and to show you online advertisements for products or services on the Services or other websites, including based on items you previously have purchased or added to your cart and other activity on the Services.
        </li>
        <li>
        ...
        <li>
          <strong>Communicating with You.</strong> We use your personal information to provide you with customer support, to be responsive to you, to provide effective services to you and to maintain our business relationship with you.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          <a href="https://vital-peptide.myshopify.com/pages/data-sharing-opt-out" rel="noopener noreferrer" target="_blank">
            here
          </a>
          .
        </li>
      ...
      <p>
        ...
        <a href="https://privacy.shopify.com/en" rel="noopener noreferrer" target="_blank">
      ...
      <ul>
        ...
        <li>
          <strong>Right to Opt out of Sale or Sharing for Targeted Advertising.</strong> Depending on where you reside, you may have a right to opt out of the &quot;sale&quot; or &quot;share&quot; of your personal information or to opt out of the processing of your personal information for purposes considered to be &quot;targeted advertising&quot;, as defined in applicable privacy laws. You can exercise your rights to opt-out of those uses{" "}
          <a href="https://vital-peptide.myshopify.com/pages/data-sharing-opt-out" rel="noopener noreferrer" target="_blank">
            here
          </a>
      ...
      <p>
        ...
        <a href="mailto:info@vitalepeptide.com">info@vitalepeptide.com</a> or contact us at 656 Central Park Avenue suite 108, Scarsdale, NY, 10583, US.
      </p>
    </>
  );
}
